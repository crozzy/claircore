...
func (m *MockStore) AffectedManifests(ctx context.Context, v claircore.Vulnerability, f claircore.CheckVulnernableFunc) ([]claircore.Digest, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AffectedManifests", ctx, v, f)
...
func (mr *MockStoreMockRecorder) AffectedManifests(ctx, v, f any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AffectedManifests", reflect.TypeOf((*MockStore)(nil).AffectedManifests), ctx, v, f)
}
...
func (m *MockStore) GetData(ctx context.Context, namespace, key string, dec func(context.Context, io.Reader) (any, error)) (any, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetData", ctx, namespace, key, dec)
	ret0, _ := ret[0].(any)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) GetData(ctx, namespace, key, dec any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetData", reflect.TypeOf((*MockStore)(nil).GetData), ctx, namespace, key, dec)
}
...
// UpdateIndexerData mocks base method.
func (m *MockStore) UpdateIndexerData(ctx context.Context, fp driver.Fingerprint, d []driver.IndexerData) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateIndexerData", ctx, fp, d)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateIndexerData indicates an expected call of UpdateIndexerData.
func (mr *MockStoreMockRecorder) UpdateIndexerData(ctx, fp, d any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateIndexerData", reflect.TypeOf((*MockStore)(nil).UpdateIndexerData), ctx, fp, d)
}
